...
impl Node {
	...
	/// Manually triggers an RGS gossip snapshot update and returns the new sync timestamp.
	///
	/// This is useful after calling [`reset_network_graph`] to immediately repopulate
	/// the graph without waiting for the background sync interval.
	///
